...
const Home = () => {
    ...
    async function hanldeGenerateReport(){
        ...
        <div className='home-page'>
            ...
            <div className='interview-card'>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <input ref={resumeInput} hidden type='file' id='resume' name='resume' accept='.pdf,.docx' />
                            </label>
                        </div>
                ...
                <div className='interview-card__footer'>
                    ...
                    <button className='generate-btn' onClick={hanldeGenerateReport}>
                        Generate My Interview Strategy
                    </button>
                </div>
            </div>

            {/* Static Recent Reports UI */}
            {reports.length > 0 && (
                ...
                <ul className='reports-list'>
                    {reports.map((report)=>{
                        return (
                        <li className='report-item' key={report._id} onClick={()=>navigate(`/interview/${report._id}`)}>
                        <h3>{report.title}</h3>
